...
// StartController 创建controller对象，并开始运行
func StartController(clientset *kubernetes.Clientset, resource string, namespace string, stopCh chan struct{}) {
...
func main() {
	...
	StartController(clientset, "pods", NAMESPACE, make(chan struct{}))
	StartController(clientset, "services", NAMESPACE, make(chan struct{}))
