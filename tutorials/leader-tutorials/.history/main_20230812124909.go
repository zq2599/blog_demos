...
func onStartedLeading(context context.Context) {

}

func startLeaderElection(clientset *kubernetes.Clientset, stop chan struct{}, context context.Context) {
	// 创建锁对象
	...
	leaderelection.RunOrDie(context, leaderelection.LeaderElectionConfig{
		...
		Callbacks: leaderelection.LeaderCallbacks{
			...
			OnStoppedLeading: func() {
				// 失去了leader时的逻辑
				klog.Infof("leader lost: %s", processId)
				os.Exit(0)
			},
