...
// APIClient manages communication with the Strimzi Kafka Bridge API Reference API v0.1.0
...
type APIClient struct {
	...
	ProducerApi *ProducerApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.ProducerApi = (*ProducerApiService)(&c.common)
